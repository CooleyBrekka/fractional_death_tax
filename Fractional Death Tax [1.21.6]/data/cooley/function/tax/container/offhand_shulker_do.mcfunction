...
$execute if data entity @s equipment.offhand.components.minecraft:container[{slot:$(shulker_slot)}].item.components."minecraft:enchantments"."minecraft:vanishing_curse" if score #tax_vanishing co_math matches 1 run scoreboard players set #item_amt co_math 0

#$execute if data entity @s equipment.offhand.components.minecraft:container[{slot:$(shulker_slot)}].item.components."minecraft:enchantments"."minecraft:vanishing_curse" if score #tax_vanishing co_math matches 1 run say execute if data entity @s equipment.offhand.components.minecraft:container[{slot:$(shulker_slot)}].item.components."minecraft:enchantments"."minecraft:vanishing_curse"
