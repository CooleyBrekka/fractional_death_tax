...
# set amount in stack
execute unless score #tax_type co_math matches 2 if score #durability co_math matches 0 run data modify storage death_tax:storage root.temp.item.item.count set from storage death_tax:storage root.temp.count

# set durability of gear
execute unless score #tax_type co_math matches 1 if score #durability co_math matches 1.. run data modify storage death_tax:storage root.temp.item.item.components."minecraft:damage" set from storage death_tax:storage root.temp.count
